...
export default function Subdisplay(props) {
    ...
    function Leave() {
        ...
        axios.post('http://localhost:3001/api/SubGreddiit/leave', {
            headers: {
    ...
    function Join() {
        const token = localStorage.getItem('token')
        axios.post('http://localhost:3001/api/SubGreddiit/join', {
            headers:
            {
                Authorization: `Bearer ${token}`
            }, params: {
    ...
    //         name: name
    //     }
    //     axios.post('http://localhost:3001/api/mysubgreddiit/deletesub', {
    //         headers : {
    //             Authorization: `Bearer ${token}`
    //         },
    //         data
