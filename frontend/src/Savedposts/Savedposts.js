...
export default function Posts() {
    ...
    //     axios.post('http://localhost:3001/api/SubGreddiit/NewPost', {
    //         headers: {
    ...
    function handleSubmitcomment(event) {
        ...
        setiscomment(false)
        const token = localStorage.getItem('token')
        axios.post('http://localhost:3001/api/newcomment', {
            headers: {
                Authorization: `Bearer ${token}`
            },
            params: {
    ...
    //     const token = localStorage.getItem('token')
    //     axios.post('http://localhost:3001/api/savepost', {
    //         headers:{
    //             Authorization: `Bearer ${token}`
    //         }, params: {
    //             post: post
    ...
    function unsavepost(post, event) {
        const token = localStorage.getItem('token')
        axios.post('http://localhost:3001/api/unsavepost', {
            headers: {
                Authorization: `Bearer ${token}`
            }, params: {
                post: post
    ...
    useEffect(() => {
        const token = localStorage.getItem('token')
        axios.get("http://localhost:3001/api/getsavedposts", {
            headers:
            {
                Authorization: `Bearer ${token}`
            }
